...
ENV TURSO_AUTH_TOKEN="dummydummydummydummydummydummydummydummydummydummy"
ENV BETTER_AUTH_SECRET="dummydummydummydummydummydummydummydummydummydummy"
ENV BETTER_AUTH_URL="http://localhost:4321"
ENV RESEND_API_KEY="dummy"
ENV KILLBILL_URL="http://127.0.0.1:8080"
ENV KILLBILL_USERNAME="dummy"
ENV KILLBILL_PASSWORD="dummy"
